...
function Post() {
    ...
    return (
        <>
            <div className='max-w-[690px] shadow my-1 bg-white rounded-lg flex flex-col'>
                <div className='flex mt-2 px-3'>
                    ...
                    <div className='m-3'>
                        ...
                        <div>15h <PublicIcon /></div>
                    </div>
                    <div className='self-center w-full flex flex-row-reverse'><MoreHorizIcon /></div>
                ...
                {openComment &&
                    <div >
                        ...
                        <div className='flex m-3'><div className='md:w-1/6 w-2/6'>
                            <img className='ml-5 max-h-12' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkSQpuRwKcQD_-_2yf6EGsw56SsFVa4jdKaQ&usqp=CAU' alt='profile' /></div>
